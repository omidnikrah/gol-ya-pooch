...
export const KeyboardShortcutsModal = () => {
  ...
  return (
    <AnimatePresence>
      {!isModalShown && (
        <motion.div
          className="fixed inset-0 flex items-center justify-center bg-[#351351] bg-opacity-60 backdrop-blur-sm z-20"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        >
          <motion.div
            className="w-[450px] p-8 bg-purple-80 rounded-2xl text-center flex flex-col gap-4"
